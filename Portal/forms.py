...
class formInventarioOff(ModelForm):
    class Meta:
        ...
        widgets ={
            'escriCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px;', 'placeholder': 'Num.'}), 
            'escriModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Modelo'}), 
            'escriCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
            ...
            'sillaCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px;', 'placeholder': 'Num.'}), 
            'sillaModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Modelo'}), 
            'sillaCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
            ...
            'LapCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px;', 'placeholder': 'Num.'}), 
            'LapModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Modelo'}), 
            'LapCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
            ...
            'proyecCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px;', 'placeholder': 'Num.'}), 
            'proyecModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Modelo'}), 
            'proyecCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
            ...
            'impreCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px;', 'placeholder': 'Num.'}), 
            'impreModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Modelo'}), 
            'impreCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
            ...
            'aguaCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px;', 'placeholder': 'Num.'}), 
            'aguaModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Marca'}), 
            'aguaCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
            ...
            'escobCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px;', 'placeholder': 'Num.'}), 
            'escobModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Marca'}), 
            'escobCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
            ...
            'extintCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px;', 'placeholder': 'Num.'}), 
            'extintModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Modelo'}), 
            'extintCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
            ...
            'jabonCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px;', 'placeholder': 'Num.'}), 
            'jabonModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Marca'}), 
            'jabonCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
            ...
            'hojasCant': forms.NumberInput(attrs={'class': 'form-control d-line-block text-center','style': 'max-width:75px', 'placeholder': 'Num.'}), 
            'hojasModelo': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Marca'}), 
            'hojasCondicion': forms.TextInput(attrs={'class': 'form-control d-line-block','style': 'max-width:200px;', 'placeholder': 'Bueno/Malo'}), 
