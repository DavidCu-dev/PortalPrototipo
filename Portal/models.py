...
class inventarioOficina(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    escriCant= models.PositiveIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
    ...
    sillaCant = models.PositiveBigIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
    ...
    LapCant = models.PositiveBigIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
    ...
    proyecCant = models.PositiveBigIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
    ...
    impreCant = models.PositiveBigIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
    ...
    aguaCant = models.PositiveBigIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
    ...
    escobCant = models.PositiveBigIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
    ...
    extintCant = models.PositiveBigIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
    ...
    jabonCant = models.PositiveBigIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
    ...
    hojasCant = models.PositiveBigIntegerField(validators=[MinLengthValidator(0), MaxLengthValidator(999)])
